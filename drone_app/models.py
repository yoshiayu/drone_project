...
#     takeoff_location = models.CharField(max_length=255, verbose_name="離陸地点")
#     landing_location = models.CharField(max_length=255, verbose_name="着陸地点")
#     takeoff_location_lat = models.FloatField()
#     takeoff_location_lng = models.FloatField()
#     landing_location_lat = models.FloatField()
#     landing_location_lng = models.FloatField()
